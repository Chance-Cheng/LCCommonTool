...
+ (UIColor *)mixColor1:(UIColor *)color1 color2:(UIColor *)color2 ratio:(CGFloat)ratio
{
    ...
    NSArray *components1 = [self getRGBDictionaryByColor:color1];
    NSArray *components2 = [self getRGBDictionaryByColor:color2];
...
//    const CGFloat *components2 = CGColorGetComponents(color2.CGColor);
    CGFloat r = [components1[0] floatValue]*ratio + [components2[0] floatValue]*(1-ratio);
    CGFloat g = [components1[1] floatValue]*ratio + [components2[1] floatValue]*(1-ratio);
    CGFloat b = [components1[2] floatValue]*ratio + [components2[2] floatValue]*(1-ratio);
//    DebugLog(@">>>>混合色 ：r = %f， g = %f，b = %f", r, g, b);
...
+ (UIColor *)getColorWithColor:(UIColor *)beginColor endColor:(UIColor *)endColor ratio:(CGFloat)ratio {
    NSArray *beginColorArr = [self getRGBDictionaryByColor:beginColor];
    NSArray *marginArray = [self getRGBDictionaryByColor:endColor];
    double red = [beginColorArr[0] doubleValue] + ratio * [marginArray[0] doubleValue];
    double green = [beginColorArr[1] doubleValue]+ ratio * [marginArray[1] doubleValue];
    double blue = [beginColorArr[2] doubleValue] + ratio * [marginArray[2] doubleValue];
